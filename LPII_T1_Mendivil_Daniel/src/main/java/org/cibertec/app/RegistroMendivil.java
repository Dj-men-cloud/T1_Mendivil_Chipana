    ...
    void buscar() {
        try {
            ...
            if (inv != null) {
                ...
                txtSalida.setText("--- DETALLE DEL INVENTARIO ---\n"); 
                txtSalida.append("Nro. Inventario : " + inv.getNroInventario() + "\n");
                txtSalida.append("Fecha Registro  : " + inv.getFecha() + "\n");
                txtSalida.append("Producto        : " + inv.getIdProducto().getNomProd() + "\n");
                txtSalida.append("Costo de Ingreso   : " + inv.getCostoIngreso() + "\n");
                txtSalida.append("Motivo de Ingreso  : " + inv.getMotivoIngreso() + "\n");
                txtSalida.append("------------------------------");
            } else {
